...
with open(sys.argv[1]) as jsonfile: # sys.argv[1] = 'test_input/STRING/SARS-CoV-2_targets.csv' = network_file in preprocess step
...
#%%
# Functions for building the Discriminator and the Generator models
